...
# Load biomarkers
seurat_obj_markers <- readRDS(paste0(path_r_objects, "/biomarkers_scgtest34_h_PBMC_healthy_resolution0.6.rds"))
```
...
seurat_obj <- RenameIdents(
 ...
 "13" = "DC2",
 "14" = "T-NK cells",
 "15" = "Basophil/Mast cells",
 "16" = "pDC",
 "17" = "Proliferative cells"
 )
...
ggsave(filename = paste0(path_r_figs, "/scgtest34_h_PBMC_healthy_cells1_clustering_annotation_umap.png"),
...
saveRDS(seurat_obj$celltypes_1,
        paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_cells1_names.rds"))

# Save Seurat object
saveRDS(seurat_obj, paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_cells1_clustering_annotation.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_cells1_clustering_annotation.rds"))
```

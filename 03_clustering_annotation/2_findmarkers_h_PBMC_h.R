...
## Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_clustering_resolutions.rds"))
seurat_obj
...
saveRDS(seurat_obj_markers, 
        file = paste0(path_r_objects, "/biomarkers_scgtest34_h_PBMC_healthy_resolution0.6.rds"))
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/biomarkers_scgtest34_h_PBMC_healthy_resolution0.6.xlsx"))

...
saveRDS(seurat_obj_markers, 
        file = paste0(path_r_objects, "/biomarkers_FIXnCUT_MouseLung_fixed_perfused_resolution0.5.rds"))
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/biomarkers_FIXnCUT_MouseLung_fixed_perfused_resolution0.5.xlsx"))

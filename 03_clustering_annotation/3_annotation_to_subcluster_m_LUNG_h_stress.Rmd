...
# Load biomarkers
seurat_obj_markers <- readRDS(paste0(path_r_objects, "/biomarkers_omniscope39_m_LUNG_healthy_stress_resolution0.3.rds"))
```
...
ggsave(filename = paste0(path_r_figs, "/omniscope39_m_LUNG_healthy_stress_cells1_clustering_annotation_umap.png"),
...
saveRDS(seurat_obj$celltypes_1,
        paste0(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_cells1_names.rds"))

# Save Seurat object
saveRDS(seurat_obj, paste0(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_cells1_clustering_annotation.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_cells1_clustering_annotation.rds"))
```

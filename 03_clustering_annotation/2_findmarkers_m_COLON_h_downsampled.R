...
saveRDS(seurat_obj_markers, 
        file = paste0(path_r_objects, "/biomarkers_scgtest32_m_COLON_healthy_downs_resolution0.3.rds"))
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/biomarkers_scgtest32_m_COLON_healthy_downs_resolution0.3.xlsx"))

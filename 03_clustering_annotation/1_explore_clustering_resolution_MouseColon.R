...
# Save image
ggsave(filename = paste0(path_r_figs, "/FIXnCUT_MouseColon_clustering_resolutions_umap.png"),
...
saveRDS(seurat_obj, 
        file = paste0(path_r_objects_out, "/FIXnCUT_MouseColon_clustering_resolutions.rds"))

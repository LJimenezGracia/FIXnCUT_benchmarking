...
# Load biomarkers
seurat_obj_markers <- readRDS(paste0(path_r_objects, "/biomarkers_FIXnCUT_MouseColon_filtered_resolution0.5.rds"))
```
...
Bnaive_genes <- c("Ms4a1", "Cd79a", "Cd79b", 
                  ...
                  "Ptprc", "Ebf1", "Cd19", "Mme" #pre-pro-B cell
                  )
...
seurat_obj <- RenameIdents(
  seurat_obj,
 "0" = "Low quality cells", # Low Q, high MT%
 "1" = "Colonocytes Mep1a+", # Mep1a
 "2" = "Transit-amplifying (TA) cells", # Tubb5, Stmn1, Cenpf, Nuscup1
 "3" = "Colonocytes Gsdmc4+",
 "4" = "Low quality cells", # Low Q, high RB%
 "5" = "Colonocytes Mep1a+", #
 "6" = "B Lymphocytes",
 "7" = "Colonocytes Emp1+", # Emp1
  "8" = "Myofibroblasts",
 "9" = "Lymphatic Endothelial cells",
 "10" = "Goblet cells", # Tff3, Manf, Ccl9
 "11" = "Paneth cells", # Mptx1
 "12" = "T-NK cells",
 "13" = "B Lymphocytes",
 "14" = "Endothelium",
 "15" = "Stromal cells",
 "16" = "Myeloid cells", # Cd14, Apoe, C1qa
 "17" = "Tuft cells", # Lrmp, Dclk1, Cd24a
 "18" = "Enteroendocrine (EEC) cells" # Chgb, Cpe, Gfra3
 )
...
ggsave(filename = paste0(path_r_figs, "/FIXnCUT_MouseColon_filtered_clustering_annotation_umap.png"),
...
saveRDS(seurat_obj$celltypes,
        paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_lineagenames.rds"))

# Save Seurat object
saveRDS(seurat_obj, paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_clustering_lineageannotation.rds"))
...
ggsave(filename = paste0(path_r_figs, "/FIXnCUT_MouseColon_filtered_clustering_annotation_cleaned_umap.png"),
       plot = gg_umap_clustering_annot)
```
...
saveRDS(seurat_obj_cleaned$celltypes,
        paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_cellsnames_cleaned.rds"))

# Save Seurat object
saveRDS(seurat_obj_cleaned, paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_clustering_annotation_cleaned.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseColon_clustering_annotation_cleaned.rds"))
```

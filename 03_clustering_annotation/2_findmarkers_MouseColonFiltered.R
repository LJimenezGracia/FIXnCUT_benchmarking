...
## Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_clustering_resolutions.rds"))
seurat_obj
...
saveRDS(seurat_obj_markers, 
        file = paste0(path_r_objects, "/biomarkers_FIXnCUT_MouseColon_filtered_resolution0.5.rds"))
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/biomarkers_FIXnCUT_MouseColon_filtered_resolution0.5.xlsx"))

...
# Load Data
## Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects_in, "/scgtest33_m_LUNG_healthy_lognorm_harmony_processed.rds"))
...
# Save image
ggsave(filename = paste0(path_r_figs, "/scgtest33_m_LUNG_healthy_clustering_resolutions_umap.png"),
...
saveRDS(seurat_obj, 
        file = paste0(path_r_objects_out, "/scgtest33_m_LUNG_healthy_clustering_resolutions.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects_out, "/scgtest33_m_LUNG_healthy_clustering_resolutions.rds"))

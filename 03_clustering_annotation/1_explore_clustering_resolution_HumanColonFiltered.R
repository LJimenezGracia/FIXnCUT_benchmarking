...
# Load Data
## Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects_in, "/FIXnCUT_HumanColon_filtered_lognorm_harmony_processed.rds"))
...
# Save image
ggsave(filename = paste0(path_r_figs, "/FIXnCUT_HumanColon_filtered_clustering_resolutions_umap.png"),
...
saveRDS(seurat_obj, 
        file = paste0(path_r_objects_out, "/FIXnCUT_HumanColon_filtered_clustering_resolutions.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects_out, "/FIXnCUT_HumanColon_filtered_clustering_resolutions.rds"))

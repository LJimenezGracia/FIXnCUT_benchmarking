...
seurat_obj <- RenameIdents(
 ...
 "8" = "Mature Goblet", # ZG16, TFF3, MUC2
 "9" = "Colonocytes 1",
 "10" = "Transit-amplifying (TA) cells cycling", # CENPF, NUSAP1
 "11" = "Stromal cells", # ADAMDEC, CCL11
 "12" = "Colonocytes 2",
 "13" = "Low quality cells",
 "14" = "Low quality cells",
 "15" = "Intestinal BEST4+OTOP2+ cells", #BEST4, OPOD2
 "16" = "Tuft cells", # SH2D6, TRPM5
 "17" = "M1 macrophages", # LYZ, CCL3

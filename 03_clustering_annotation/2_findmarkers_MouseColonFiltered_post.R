...
saveRDS(seurat_obj_markers, 
        file = paste0(path_r_objects, "/biomarkers_FIXnCUT_MouseColon_filtered_post_resolution0.4.rds"))
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/biomarkers_FIXnCUT_MouseColon_filtered_post_resolution0.4.xlsx"))

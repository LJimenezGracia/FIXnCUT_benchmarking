...
# Load biomarkers
seurat_obj_markers <- readRDS(paste0(path_r_objects, "/biomarkers_FIXnCUT_MouseLung_fixed_resolution0.5.rds"))
```
...
seurat_obj <- RenameIdents(
 ...
 "10" = "Macrophages Apoe+",
 "11" = "Fibroblasts",
 "12" = "Monocyte-derived DCs", 
 "13" = "Pneumocytes Type I",
 "14" = "Neutrophils",
 "15" = "Vein cells",
 "16" = "Fibroblasts",
 "17" = "Pneumocytes Type II",
 "18" = "B cells",
 "19" = "Low quality cells",
 "20" = "Cycling cells",
 "21" = "Low quality cells",
 "22" = "Lymphatic Endothelial cells",
 "23" = "Doublets",
 "24" = "Doublets",
 "25" = "Club cells",
 "26" = "Low quality cells", 
 "27" = "Low quality cells",
 "28" = "Pericytes",
 "29" = "Doublets"
 )
...
ggsave(filename = paste0(path_r_figs, "/FIXnCUT_MouseLung_fixed_clustering_annotation_umap.png"),
...
saveRDS(seurat_obj$celltypes,
        paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_cellsnames.rds"))

# Save Seurat object
saveRDS(seurat_obj, paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_clustering_annotation.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_clustering_annotation.rds"))
```
...
ggsave(filename = paste0(path_r_figs, "/FIXnCUT_MouseLung_fixed_clustering_annotation_cleaned_umap.png"),
       plot = gg_umap_clustering_annot)
```
...
saveRDS(seurat_obj_cleaned$celltypes,
        paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_cellsnames_cleaned.rds"))

# Save Seurat object
saveRDS(seurat_obj_cleaned, paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_clustering_annotation_cleaned.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_clustering_annotation_cleaned.rds"))
```
...
# Save Seurat object
saveRDS(seurat_obj_c, paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_clustering_annotation_cleaned-NoNeutrophils.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_clustering_annotation_cleaned-NoNeutrophils.rds"))
```

## Cell proportions
```{r fig.width=12, fig.height=6}
gg_cell_num <- dittoBarPlot(seurat_obj_c, 
                            "celltypes",
                            group.by = "library_name",
                            scale = "count",
                            retain.factor.levels = TRUE,
...
gg_cell_prop <- dittoBarPlot(seurat_obj_c, 
                             "celltypes",
                             group.by = "library_name",
                             scale = "percent",
                            retain.factor.levels = TRUE,

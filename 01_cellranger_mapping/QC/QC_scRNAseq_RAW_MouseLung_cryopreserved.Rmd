...
seqreads_genes_df$library <- factor(x = seqreads_genes_df$library, levels = c("Fixed", "Cryopreserved", "Fixed+Cryopreserved"))
...
cell_info_df$library <- factor(x = cell_info_df$library, levels = c("Fixed", "Cryopreserved", "Fixed+Cryopreserved"))
...
ggsave("figs/MouseLung_cryo_LibReadsvsReadsCell.svg",
       width = 8, height = 5,
       dpi = 300)
```
...
detectedgenes$library_name <- factor(x = detectedgenes$library_name, levels = c("Fixed", "Cryopreserved", "Fixed+Cryopreserved"))

...
write_csv(x = seqreads_genes_df,
          file = "tables/HumanPBMC_LibGenesUMIvsReads.csv")
```


## # Genes / Seq reads
```{r fig.width=8, fig.height=5}
seqreads_genes_df <- read.csv("tables/HumanPBMC_LibGenesUMIvsReads.csv")
...
ggsave(plot=gg,  filename = "figs/HumanPBMC_LibGenesUMIvsReads.svg",
       width = 8, height = 5,
       dpi = 300)
```
...
detectedgenes_df <- dplyr::rename(detectedgenes_df, "Fixed" = `Fix&Cut_24h`)
...
## QC metrics
```{r}
table_qc_gex(seurat_obj@meta.data, subtitle = "Library QC")
```

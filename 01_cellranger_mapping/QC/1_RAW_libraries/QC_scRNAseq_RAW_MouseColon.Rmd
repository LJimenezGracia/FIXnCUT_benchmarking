...
write_csv(x = seqreads_genes_df,
          file = "tables/MouseColon_LibGenesUMIvsReads.csv")
```


## # Genes / Seq reads
```{r fig.width=8, fig.height=5}
seqreads_genes_df <- read.csv("tables/MouseColon_LibGenesUMIvsReads.csv")
...
gg_genes <- seqreads_genes_df %>%
  ...
  scale_x_continuous(labels = label_number(scale = 1e-6), breaks = seq(0, 40000000, by = 10000000)) +
  theme_classic() +
...
ggsave(plot=gg,  filename = "figs/MouseColon_LibGenesUMIvsReads.svg",
       width = 8, height = 5,
       dpi = 300)
```

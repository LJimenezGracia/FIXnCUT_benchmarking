...
```{r}
seq_list <- c(20000000, 30000000, 40000000, 50000000, 60000000, 70000000, 80000000, 90000000, 100000000, 110000000, 120000000)
...
ggsave("figs/MouseLung_fixed_LibReadsvsReadsCell.svg",
       width = 8, height = 5,
       dpi = 300)
```

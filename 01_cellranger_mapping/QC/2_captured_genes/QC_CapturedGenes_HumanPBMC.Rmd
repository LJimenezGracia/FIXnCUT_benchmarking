---
title: "scRNAseq Captured Genes: Human PBMC"
...
metadata <- metadata %>% 
  filter(subproject == "SCGTEST_34"
         & tissue == "PBMC"
         & ( sample_protocol == "Fresh" | sample_protocol == "Fix&Cut_24h"))

# Modify metadata
metadata$library_name[metadata$library_name == "CNAG81_fresh"] <- "Fresh"
metadata$library_name[metadata$library_name == "CNAG81_fixed"] <- "Fixed"
...
seurat_obj$library_name <- factor(seurat_obj$library_name, levels = c("CNAG81_fresh", "CNAG81_fixed"), 
                                  labels = c("Fresh", "Fixed"))

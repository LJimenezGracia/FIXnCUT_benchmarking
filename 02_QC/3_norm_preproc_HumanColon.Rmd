---
title: "Data normalization and pre-processing: HumanColon"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_HumanColon_filtered.rds"))
...
saveRDS(seurat_obj, paste0(path_r_objects, "/FIXnCUT_HumanColon_lognorm_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_HumanColon_lognorm_processed.rds"))
```
...
```{r}
# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/FIXnCUT_HumanColon_lognorm_harmony_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_HumanColon_lognorm_harmony_processed.rds"))
```

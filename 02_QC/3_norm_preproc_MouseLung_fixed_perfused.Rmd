---
title: "Data normalization and pre-processing: MouseLung_fixed_perfused"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_perfused_filtered.rds"))
seurat_obj
```
...
saveRDS(seurat_obj, paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_perfused_lognorm_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_perfused_lognorm_processed.rds"))
```

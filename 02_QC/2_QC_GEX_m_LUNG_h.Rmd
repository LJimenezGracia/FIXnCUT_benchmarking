---
title: "GEX Quality control: mouse_LUNG_healthy"
...
path_cellranger_data <- here::here(paste0("01_cellranger_mapping/subprojects/SCGTEST_33/jobs"))
...
tissue <- "LUNG"
# Metadata
aggr_csv_path <- paste0(path_cellranger_data, "_aggr/", tissue, "/", tissue, "_aggr.csv")
...
## Counts data
filtered_matrix_path <- paste0(path_cellranger_data, "_aggr/", tissue, "/", tissue, "/outs/count/filtered_feature_bc_matrix")
...
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest33_m_LUNG_healthy_merged.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/scgtest33_m_LUNG_healthy_merged.rds"))
```
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest33_m_LUNG_healthy_filtered.rds"))

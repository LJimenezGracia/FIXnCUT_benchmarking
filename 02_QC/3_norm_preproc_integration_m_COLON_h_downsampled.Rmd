---
title: "Data normalization and pre-processing: mouse_COLON_healthy"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/scgtest32_m_COLON_healthy_filtered_downs.rds"))
seurat_obj
```
...
saveRDS(seurat_obj, paste0(path_r_objects, "/scgtest32_m_COLON_healthy_downs_lognorm_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/scgtest32_m_COLON_healthy_downs_lognorm_processed.rds"))
```
...
# Non-immune fraction
FeaturePlot(seurat_obj_integrated,
            features = c("Epcam", "Krt18", "Krt19", # Epithelial cells
                        "Pecam1", "Aqp1", # Endothelial cells
                        "Lyve1", # Lymphatic endothelial cells
                        "Col1a1", # Stromal cells
                      "Dpt", "Ly6a", "Pi16", # Fibroblasts
                       "Clu", "Slpi", # Mesothelial cells
                       "Rgs5", "Acta2", "Fabp4", #pericytes
                      "Lypd8", "Car1", # Intestinal cells
                       "Mki67", "Top2a", "Stmn1" # cycling
                         ),
            order = T,
            ncol = 6) &
  scale_colour_gradientn(colours = inferno_color_palette)
...
```{r}
# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/scgtest32_m_COLON_healthy_downs_lognorm_harmony_processed.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/scgtest32_m_COLON_healthy_downs_lognorm_harmony_processed.rds"))
```

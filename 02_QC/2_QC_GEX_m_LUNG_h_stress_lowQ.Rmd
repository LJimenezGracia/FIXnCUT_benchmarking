...
saveRDS(seurat_obj, str_c(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_filtered_lowQ.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_filtered_lowQ.rds"))
```

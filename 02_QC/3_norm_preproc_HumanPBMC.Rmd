---
title: "Data normalization and pre-processing: HumanPBMC"
...
# Parameters
confounder_variables <- c("condition", "sample_protocol")
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_HumanPBMC_filtered.rds"))
seurat_obj
```
...
seurat_obj_list <- SplitObject(seurat_obj, split.by = "condition")
...
saveRDS(seurat_obj, paste0(path_r_objects, "/FIXnCUT_HumanPBMC_lognorm_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_HumanPBMC_lognorm_processed.rds"))
```

---
title: "Data normalization and pre-processing: MouseColon_filtered"
...
# Load Seurat object
seurat_obj_epi <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseColonEpithelial_filtered.rds"))
seurat_obj_Nepi <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseColonNonEpithelial_filtered.rds"))
seurat_obj <- merge(seurat_obj_epi, seurat_obj_Nepi)
seurat_obj

seurat_obj$library_name <- factor(x = seurat_obj$library_name, levels = c("Fresh", "Fixed"))
seurat_obj$sample_protocol <- factor(x = seurat_obj$sample_protocol, levels = c("Fresh", "Fixed"))
```
...
saveRDS(seurat_obj, paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_lognorm_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_lognorm_processed.rds"))
```
...
```{r}
# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_lognorm_harmony_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_lognorm_harmony_processed.rds"))
```

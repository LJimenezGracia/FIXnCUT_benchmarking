---
title: "GEX Quality control: HumanPBMC"
...
subproject_folder <- "SCGTEST_34"
subproject_folder_n <- "HumanPBMC"
...
seurat_obj$condition[seurat_obj$sample_protocol == "Fix&Cut_24h"] <- "Fixed"
```
...
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_HumanPBMC_merged.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_HumanPBMC_merged.rds"))
```
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_HumanPBMC_filtered.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_HumanPBMC_filtered.rds"))
```

...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_filtered.rds"))
seurat_obj
```
...
```{r}
# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_lognorm_harmony_processed.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/omniscope39_m_LUNG_healthy_stress_lognorm_harmony_processed.rds"))
```

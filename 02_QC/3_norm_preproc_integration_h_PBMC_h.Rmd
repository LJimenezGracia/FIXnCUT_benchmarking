---
title: "Data normalization and pre-processing: human_PBMC_healthy"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_filtered.rds"))
seurat_obj
```
...
saveRDS(seurat_obj, paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_lognorm_processed.rds"))
...
```{r}
# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_lognorm_harmony_processed.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/scgtest34_h_PBMC_healthy_lognorm_harmony_processed.rds"))
```

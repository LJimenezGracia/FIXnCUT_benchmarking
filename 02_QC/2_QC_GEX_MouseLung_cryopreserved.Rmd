---
title: "GEX Quality control: MouseLung_cryopreserved"
...
subproject_folder_n <- "MouseLung_cryopreserved"

# Merging metadata tables
metadata <- metadata %>% 
  filter(subproject == "SCGTEST_33"
         & tissue == "Lung"
         & ( library_name != "Lung_fresh" & library_name != "Lung_fixed_7days"))
...
metadata$library_name[metadata$library_name == "Lung_fixed_cryo"] <- "Fixed+Cryopreserved"
...
metadata_aggr$library_name[metadata_aggr$library_name == "Lung_cryo"] <- "Cryopreserved"
metadata_aggr$library_name[metadata_aggr$library_name == "Lung_fixed_cryo"] <- "Fixed+Cryopreserved"
...
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_MouseLung_cryopreserved_merged.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_MouseLung_cryopreserved_merged.rds"))
```
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_MouseLung_cryopreserved_filtered.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_MouseLung_cryopreserved_filtered.rds"))
```

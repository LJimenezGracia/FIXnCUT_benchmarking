...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/scgtest32_m_LUNG_healthy_filtered_downs.rds"))
seurat_obj
```
...
saveRDS(seurat_obj, paste0(path_r_objects, "/scgtest32_m_LUNG_healthy_downs_lognorm_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/scgtest32_m_LUNG_healthy_downs_lognorm_processed.rds"))
```
...
```{r}
# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/scgtest32_m_LUNG_healthy_downs_lognorm_harmony_processed.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/scgtest32_m_LUNG_healthy_downs_lognorm_harmony_processed.rds"))
```

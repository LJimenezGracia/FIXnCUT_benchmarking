---
title: "GEX Quality control: MouseColon"
...
# Modify metadata
metadata_aggr$library_name[metadata_aggr$library_name == "Colon_fresh"] <- "Fresh"
metadata_aggr$library_name[metadata_aggr$library_name == "Colon_fixed_24h"] <- "Fixed"
...
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_MouseColon_merged.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_MouseColon_merged.rds"))
```
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_MouseColon_filtered.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_MouseColon_filtered.rds"))
```

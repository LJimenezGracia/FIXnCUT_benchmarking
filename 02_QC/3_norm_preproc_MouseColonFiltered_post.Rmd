...
path_r_objects_out <- here::here("02_QC/results/R_objects")
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects_in, "/FIXnCUT_MouseColon_filtered_clustering_annotation_cleaned.rds"))
...
saveRDS(seurat_obj, paste0(path_r_objects_out, "/FIXnCUT_MouseColon_filtered_post_lognorm_processed.rds"))
...
```{r}
# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects_out, "/FIXnCUT_MouseColon_filtered_post_lognorm_harmony_processed.rds"))

...
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest32_m_LUNG_healthy_merged_downs.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/scgtest32_m_LUNG_healthy_merged_downs.rds"))
```
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest32_m_LUNG_healthy_filtered_downs.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/scgtest32_m_LUNG_healthy_filtered_downs.rds"))
```

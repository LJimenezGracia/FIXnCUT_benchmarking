---
title: "GEX Quality control: MouseLung_fixed"
...
## Load data
The data used in this Rmarkdown document comes from **SCGTEST_32 & SCGTEST_33** dataset, filtered matrices were processed with `cellranger v6.1.1`, and the doublet predictions were obtained using `scrublet`.
```{r}
...
# Modify metadata
metadata_aggr$library_name[metadata_aggr$library_name == "Lung_fresh_0"] <- "Fresh_1"
metadata_aggr$library_name[metadata_aggr$library_name == "Lung_fresh"] <- "Fresh_2"
metadata_aggr$library_name[metadata_aggr$library_name == "Lung_fixed_24h_0"] <- "Fixed_1"
metadata_aggr$library_name[metadata_aggr$library_name == "Lung_fixed_24h"] <- "Fixed_2"
...
seurat_obj$replicate <- as.factor(seurat_obj_metadata$replicate)
```
...
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_MouseLung_fixed_merged.rds"))
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/FIXnCUT_MouseLung_fixed_filtered.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_MouseLung_fixed_filtered.rds"))
```

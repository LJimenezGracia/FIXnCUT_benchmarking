---
title: "GEX Quality control: mouse_COLON_healthy"
...
path_cellranger_data <- here::here(paste0("01_cellranger_mapping/subprojects/SCGTEST_32/jobs"))
...
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest32_m_COLON_healthy_merged_downs.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/scgtest32_m_COLON_healthy_merged_downs.rds"))
```
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest32_m_COLON_healthy_filtered_downs.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/scgtest32_m_COLON_healthy_filtered_downs.rds"))
```

---
title: "GEX Quality control: human_PBMC_healthy"
...
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest34_h_PBMC_healthy_merged.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/scgtest34_h_PBMC_healthy_merged.rds"))
```
...
```{r}
# Save Merged Seurat object
saveRDS(seurat_obj, str_c(path_r_objects, "/scgtest34_h_PBMC_healthy_filtered.rds"))
#seurat_obj <- readRDS(str_c(path_r_objects, "/scgtest34_h_PBMC_healthy_filtered.rds"))
```

...
group_1_list <- c("Stress_Fix&Cut")
group_2_list <- c("Stress_Fresh")
...
for (index in 1:length(comparison_name_list)) {
  ...
  path_object <- paste0(path_r_objects_out, "/omniscope39_m_LUNG_healthy_stress_DEgenes_", comparison_name, ".rds")
  path_file <- paste0(path_r_tables, "/omniscope39_m_LUNG_healthy_stress_DEgenes_", comparison_name, ".csv")
  path_file_split <- paste0(path_r_tables, "/omniscope39_m_LUNG_healthy_stress_DEgenes_", comparison_name, "_UPDOWN.xlsx")

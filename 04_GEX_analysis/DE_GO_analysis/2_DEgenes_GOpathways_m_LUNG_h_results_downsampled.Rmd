...
for (index in 1:length(comparison_name_list)) {
  ...
  # Load data
  path_object <- paste0(path_r_objects, "/scgtest32_m_LUNG_healthy_downs_DEgenes_", comparison_name, "_subset.rds")
...
# Save results
path_hallmark <- paste0(path_r_tables, "/scgtest32_m_LUNG_healthy_downs_hallmark_enrichment_subset.xlsx")

...
# Excluding Neutrophils & Low quality cells
...
for (index in 1:length(comparison_name_list)) {
  ...
  path_object <- paste0(path_r_objects_out, "/scgtest32_m_COLON_healthy_downs_DEgenes_", comparison_name, ".rds")
  path_file <- paste0(path_r_tables, "/scgtest32_m_COLON_healthy_downsy_DEgenes_", comparison_name, ".csv")
  path_file_split <- paste0(path_r_tables, "/scgtest32_m_COLON_healthy_downs_DEgenes_", comparison_name, "_UPDOWN.xlsx")

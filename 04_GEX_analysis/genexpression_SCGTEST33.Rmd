...
Myeloid_signature <- c("S100a4", "Cd14", "Lyz2", "Ccr2", "Ly6c2", "Plac8")
...
VlnPlot(
  ...
  idents = "Monocytes/Macrophages/DCs",
  group.by = "sample_protocol",
  cols = color_palette, 
  pt.size = 0,
  ncol = 1) &
...
seurat_obj$sample_protocol <- factor(
  x = seurat_obj$sample_protocol,
  levels=c("Fresh", "Fix&Cut_24h", "Cryopreservation", "Fix&Cut+Cryopreservation", "Fix&Cut_7d")
  )
...
RidgePlot(seurat_obj,
          features = "Myeloid_signature4",
  idents = c("Monocytes/Macrophages/DCs"),
  group.by = "sample_protocol")
```

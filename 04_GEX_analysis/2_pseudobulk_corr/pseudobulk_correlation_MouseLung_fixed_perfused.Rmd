...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_Pseudobulk.svg"),
       width = 5, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_Pseudobulk_hallmarks.svg"),
       width = 15, height = 10,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_Pseudobulk_cells_downs.png"),
       width = 20, height = 12,
       dpi = 300)
```

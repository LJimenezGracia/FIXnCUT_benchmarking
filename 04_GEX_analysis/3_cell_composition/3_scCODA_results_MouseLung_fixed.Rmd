...
sccoda_effect_df_list <- purrr::map2(comparison_name_list, 
  ...
  file_path <- paste0(path_r_tables, "/MouseLung_fixed_scCODA_", comparison_name, "_effect.tsv")
...
gg_dotplot_effect_glob <- sccoda_effect_global_df %>%
  filter(comparison_fraction == "MouseLung") %>% 
    ...
    labs(title = "scCODA: MouseLung_fixed",
         color = "Log2FC",
...
fig_path <- paste0(path_r_figs, "/MouseLung_fixed_scCODA_dotplot_Fixed-Fresh_celltype.png")

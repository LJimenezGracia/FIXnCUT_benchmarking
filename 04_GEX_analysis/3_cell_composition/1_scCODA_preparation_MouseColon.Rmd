...
```{r}
# using cleaned data
seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_MouseColon_filtered_post_clustering_annotation.rds"))
...
openxlsx::write.xlsx(celltype_prop_df,
                     file = paste0(path_r_tables_out, "/FIXnCUT_MouseColon_clustering_annotation_counts.xlsx"))
```

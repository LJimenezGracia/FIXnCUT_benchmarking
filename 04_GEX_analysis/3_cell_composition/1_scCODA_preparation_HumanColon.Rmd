...
```{r}
# using cleaned data
seurat_obj <- readRDS(paste0(path_r_objects, "/FIXnCUT_HumanColon_filtered_clustering_annotation_cleaned.rds"))
...
openxlsx::write.xlsx(celltype_counts,
                     file = paste0(path_r_tables_out, "/FIXnCUT_HumanColon_filtered_clustering_annotation_cleaned_counts.xlsx"))
```

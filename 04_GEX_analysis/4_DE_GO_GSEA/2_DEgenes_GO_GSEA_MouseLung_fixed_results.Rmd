...
for (index in 1:length(comparison_name_list)) {
  ...
  # Load data
  path_object <- paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_DEgenes_", comparison_name, ".rds")
  ...
  # Save results
  path_volcanoplot <- paste0(path_r_figs, "/FIXnCUT_MouseLung_fixed_DEA_", comparison_name, ".svg")
...
for (index_1 in 1:length(comparison_name_list)) {
  ...
  # Save results
  path_GSEArds <- paste0(path_r_objects, "/GSEA/FIXnCUT_MouseLung_fixed_GSEA_", comparison_name, "_", category_db ,".rds")
  saveRDS(fgseaRes_split, file = path_GSEArds)
  
  path_GSEAtable <- paste0(path_r_figs, "/GSEA/FIXnCUT_MouseLung_fixed_GSEAtop_", comparison_name, "_", category_db , ".svg")
  ggsave(plot = gg_GSEAresults, filename = path_GSEAtable, width = 15, height = 10, dpi = 300)
  
  results_path <- paste0(path_r_tables, "/GSEA/FIXnCUT_MouseLung_fixed_GSEA_", comparison_name, "_", category_db ,".xlsx")

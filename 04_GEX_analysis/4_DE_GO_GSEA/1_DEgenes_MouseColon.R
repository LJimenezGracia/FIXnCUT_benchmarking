...
for (index in 1:length(comparison_name_list)) {
  ...
  path_object <- paste0(path_r_objects_out, "/FIXnCUT_MouseColon_DEgenes_", comparison_name, ".rds")
  path_file <- paste0(path_r_tables, "/FIXnCUT_MouseColon_DEgenes_", comparison_name, ".csv")
  path_file_split <- paste0(path_r_tables, "/FIXnCUT_MouseColon_DEgenes_", comparison_name, "_UPDOWN.xlsx")
  ...
  Idents(seurat_obj_sub) <- "library_name"

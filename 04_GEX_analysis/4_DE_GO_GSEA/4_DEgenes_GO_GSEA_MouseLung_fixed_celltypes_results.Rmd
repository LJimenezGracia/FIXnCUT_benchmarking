...
for (index in 1:length(comparison_name_list)) {
  ...
  # Load data
  path_object <- paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_DEgenes_cells_", comparison_name, ".rds")
  ...
  # Save results
  path_volcanoplot <- paste0(path_r_figs, "/FIXnCUT_MouseLung_fixed_DEAcells_", comparison_name, ".svg")
  ...
  # Save results
  path_GSEArds <- paste0(path_r_objects, "/GSEA/FIXnCUT_MouseLung_fixed_GSEAcells_", comparison_name, "_", category_db ,".rds")
  saveRDS(fgsea_vector, file = path_GSEArds)
  
  results_path <- paste0(path_r_tables, "/GSEA/FIXnCUT_MouseLung_fixed_GSEAcells_", comparison_name, "_", category_db ,".xlsx")

...
seurat_obj$celltypes <- factor(x = seurat_obj$celltypes,
                                    levels = c("CD4+ T cells", "CD8+ T cells", "NK cells", "M0 macrophages", "M1 macrophages", 
...
palette_color_cells <- c("CD4+ T cells" = "#E2711D",
                         ...
                         "Intestinal BEST4+OTOP2+ cells" = "#34A0A4",
                         "Transit-amplifying (TA) cells cycling"= "#52B69A",
                         "Mature Goblet"  = "#76C893",
                         "Tuft cells" = "#99D98C",
                         "Endothelium" = "#BB9457",
...
genes_of_interest <- c("CD3D", "CD4", # cd4+ T cells
                       ...
                       "CD86", "SELENOP", "CCL3", # M1 macrophages

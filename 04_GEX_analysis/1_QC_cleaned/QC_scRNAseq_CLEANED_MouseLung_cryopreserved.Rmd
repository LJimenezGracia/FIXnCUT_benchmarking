...
ggsave(paste0(path_r_figs_out, "/MouseLung_cryo_QCmetrics-NoNeu.svg"),
       width = 15, height = 6,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_cryo_UMAPcelltypes-NoNeu.svg"),
       width = 10, height = 7,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_cryo_CellProp-NoNeu.svg"),
       width = 10, height = 5,
       dpi = 300)
```

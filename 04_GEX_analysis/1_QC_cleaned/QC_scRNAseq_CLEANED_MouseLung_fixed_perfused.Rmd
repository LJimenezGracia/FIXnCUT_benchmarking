...
```{r}
# Load Seurat object
seurat_obj <- readRDS(here::here("03_clustering_annotation/results/R_objects/FIXnCUT_MouseLung_fixed_perfused_clustering_annotation_cleaned.rds"))
seurat_obj
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_PCA.svg"),
       width = 7, height = 6,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_UMAP.svg"),
       width = 7, height = 6,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_QCmetrics.svg"),
       width = 10, height = 4,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_QCmetricsCell.svg"),
       width = 15, height = 7,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_UMAPcelltypes.svg"),
       width = 10, height = 7,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_CellProp.svg"),
       width = 12, height = 6,
       dpi = 300)
```
...
DotPlot(seurat_obj,
  ...
  guides(
    color = guide_colorbar(ncol = 6, title.position = "top", title.hjust = 0.5, label.hjust = 0.5, order = 1),
    size = guide_legend(ncol = 5, title.position = "top", title.hjust = 0.5, label.hjust = 0.5, order = 2)
    )

ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_DotplotMarkers.svg"),
       width = 6, height = 12,
       dpi = 300)
```

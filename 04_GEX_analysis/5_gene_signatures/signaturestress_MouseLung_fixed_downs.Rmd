...
palette_color_factor <- c("Fresh" = "#66C2A5", 
                          "Fixed" ="#FC8D62")
palette_color_library <- c("Fixed_1" = "#D53E4F",
                           "Fixed_2" = "#FDAE61",
                           "Fresh_1" = "#ABDDA4",
                           "Fresh_2" = "#3288BD")
...
```{r}
# Load Seurat object
seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_MouseLung_fixed_clustering_annotation_cleaned-NoNeutrophils.rds"))
...
# Downsampling sample
df <- data.frame(condition=seurat_obj$library_name, cell_type=seurat_obj$celltypes)
df$barcode <- rownames(df)
df_new <- df %>% 
  group_by(condition, cell_type) %>%
  slice_sample(n=250, replace = F) #  sample w/i each condition/celltype
table(df_new$condition, df_new$cell_type)
cells_to_keep <- df_new$barcode
...
VlnPlot(
  ...
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5),
        ...
        axis.title.x = element_blank(),
        strip.text = element_text(size=20))  &
  aes(alpha=seurat_obj$replicate) &
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_vandenBrinketalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_vandenBrinketalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
path_object_DEgenes <- paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_DEgenes_Fixed_vs_Fresh.rds")
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_vandenBrinketalUPgenes_DEgenes.svg"),
       width = 12, height = 9,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_OFlanaganetalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_OFlanaganetalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_OFlanaganetalUPgenes_DEgenes.svg"),
       width = 12, height = 9,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_DenisenkoatalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_DenisenkoatalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_DenisenkoetalUPgenes_DEgenes.svg"),
       width = 12, height = 9,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_MassonietalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_MassonietalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_MassonietalUPgenes_DEgenes.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_BaechleretalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_BaechleretalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_BaechleretalUPgenes_DEgenes.svg"),
       width = 12, height = 8,
       dpi = 300)
```

...
```{r}
# Load Seurat object
seurat_obj <- readRDS(str_c(path_r_objects, "/FIXnCUT_MouseLung_fixed_perfused_clustering_annotation_cleaned.rds"))
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_vandenBrinketalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_vandenBrinketalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
path_object_DEgenes <- paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_perfused_DEgenes_Fixed_vs_Fresh.rds")
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_vandenBrinketalUPgenes_DEgenes.svg"),
       width = 12, height = 9,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_OFlanaganetalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_OFlanaganetalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_OFlanaganetalUPgenes_DEgenes.svg"),
       width = 12, height = 9,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_DenisenkoatalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_DenisenkoatalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
## Comparing signature with Fresh/Fixed sDEgenes
```{r}
path_r_objects <- here::here("04_GEX_analysis/4_DE_GO_GSEA/results/R_objects")
path_object_DEgenes <- paste0(path_r_objects, "/FIXnCUT_MouseLung_fixed_perfused_DEgenes_Fixed_vs_Fresh.rds")
DE_genes <- readRDS(path_object_DEgenes)
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_DenisenkoetalUPgenes_DEgenes.svg"),
       width = 12, height = 9,
       dpi = 300)
```
...
UpSetR::upset(
  UpSetR::fromList(list(
    "DEG in Fresh" = DE_genes_DOWN_list,
    "DEG in Fixed" = DE_genes_UP_list,
  ...
  #empty.intersections = "on",
   queries = list(
     list(query = intersects, params = list("DEG in Fresh"), color = "green", active = T),
     list(query = intersects, params = list("DEG in Fixed"), color = "orange", active = T)
     )
  )
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_MassonietalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_MassonietalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_MassonietalUPgenes_DEgenes.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_BaechleretalUPgenes_Ucell_Vlnbycells.svg"),
       width = 12, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_BaechleretalUPgenes_Ucelldensity.svg"),
       width = 10, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/MouseLung_fixed_perfused_BaechleretalUPgenes_DEgenes.svg"),
       width = 12, height = 8,
       dpi = 300)
```

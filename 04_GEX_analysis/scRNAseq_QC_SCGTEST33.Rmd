...
```{r}
# Load Seurat object
seurat_obj <- readRDS(here::here("02_QC/results/R_objects/scgtest33_m_LUNG_healthy_merged.rds"))
seurat_obj
```
...
detectedgenes <- detectedgenes_df %>% 
  gather(key = "sample_protocol", value = "detected_genes", `Fresh`:`Fix&Cut+Cryopreservation`)
```
...
```{r}
# Load Seurat object
seurat_obj <- readRDS(here::here("03_clustering_annotation/results/R_objects/scgtest33_m_LUNG_healthy_cells1_clustering_annotation.rds"))
seurat_obj
